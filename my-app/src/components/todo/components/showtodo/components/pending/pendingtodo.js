...
export default function PendingTodo({data}){
  ...
  data.map(todo => {
    return (
      <div key={todo.id} className="rounded card-color my-2 d-flex justify-content-between align-items-center px-3 card-container-boxshadow" style={{height:"50px", width:"650px", position:'relative'}}>
